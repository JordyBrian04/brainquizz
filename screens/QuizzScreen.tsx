...
const QuizzScreen = ({ navigation, route }: any) => {
    ...
    const duration = soundStatus?.isLoaded ? soundStatus.durationMillis : 1;
  ...
  async function loadSound() {
    ...
    const { sound } = await Audio.Sound.createAsync(allQuestion[currentQuestionIndex]?.question, {progressUpdateIntervalMillis: 1000/60}, onPlaybackStatusUpdate);
    setSound(sound);
