    ...
    <View className='bg-[#F9F7F7] flex-1 pt-8 pr-4 pl-4'>
      <ScrollView className='mt-6'>
            ...
            <View className='mt-4 flex-row items-center'>
                <View className='w-10 h-10 bg-[#EED42A] rounded-full items-center justify-center'>
                    <Image source={require('../assets/stickNyote.png')} className='w-5 h-5' style={{tintColor : '#FFFFFF'}} />
                </View>
                <Text className='ml-2 text-lg' style={{fontFamily:'Medium'}}>Règle du jeu</Text>
            </View>
