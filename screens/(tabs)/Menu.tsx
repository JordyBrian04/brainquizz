      ...
      <ScrollView>
        ...
        <View className='absolute p-3 right-0 flex-row items-center justify-end w-full'>
            ...
            <View className='w-[40%] p-2 bg-[#0C833E] rounded-2xl items-center justify-center'>
                <Text className='text-white ml-4 text-xs text-center' style={{fontFamily: 'Medium'}}>{currentUser.balance.toLocaleString()}</Text>
            </View>
        </View>
        ...
        <ScrollView horizontal={true} contentContainerStyle={{alignItems: 'center', alignContent: 'center', justifyContent: 'center'}}>
          {dateCardStatus.map(dateCardStat => {
            return (
              <View key={dateCardStat?.id}>
                ...
                <TouchableOpacity className='w-[110px] h-[130px] bg-white items-center rounded-xl mr-3 p-1' 
